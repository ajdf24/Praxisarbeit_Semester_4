...
Das \ac{GDS} verwendet Objekte um Anwendungsdaten zu verwalten, die einem \ac{OPM} genügen und durch \ac{SMD} beschrieben werden k\"onnen.
...
Strukturelle Metadaten sind laut der \ac{OPM}-Definition spezielle Metadaten, die den Aufbau einer Programmklasse enthalten. Die Informationen der \ac{SMD} sind programmiersprachenunabhängig und stehen dem Anwendungsprogrammen zur Verfügung.

Die Metadaten werden in einer SQL-Datenbank gespeichert, wo sie wenn benötigt geladen werden können. \cite{Zil14}
